...
Key method: aggregate_events_to_sessions() - converts raw events into session format
"""
...
class SessionAggregator:
    ...
    def aggregate_events_to_sessions(
        ...
        This is the main method that converts raw StandardEvent objects
        into SessionInput format expected by Behavior Agent.
        ...
        SessionInput format:
        {
            ...
            'is_outside_hours': int (0 or 1),
            'duration_minutes': float,
            'file_count': int,
            'max_sensitivity': int,
            'usb_connected': int (0 or 1),
            'usb_first_time': int (0 or 1),
            'email_count': int,
            'has_ext_email': int (0 or 1),
            'visited_exfil_domain': int (0 or 1),
            'visited_jobsearch_domain': int (0 or 1),
            'simulated': bool
        }
        """
        if not events:
