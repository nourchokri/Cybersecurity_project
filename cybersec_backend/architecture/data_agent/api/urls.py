...
urlpatterns = [
    ...
    path('stored-events/', views.StoredEventsView.as_view(), name='stored-events'),
    path('analyze-stored-network/', views.AnalyzeStoredNetworkEventsView.as_view(), name='analyze-stored-network'),
]
