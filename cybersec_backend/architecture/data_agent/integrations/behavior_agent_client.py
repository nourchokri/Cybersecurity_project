...
collected data from Data Agent to Behavior Agent.
"""
...
class BehaviorAgentClient:
    ...
    def __init__(self, base_url: str = 'http://127.0.0.1:8000'):
        ...
        self.timeout = 600.0  # Batch can take very long: each session = LLM scoring + risk forwarding
    ...
    def send_sessions(
        ...
        """
        Send sessions to Behavior Agent for analysis.
