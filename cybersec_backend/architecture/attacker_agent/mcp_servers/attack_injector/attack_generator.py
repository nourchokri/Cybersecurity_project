...
from architecture.data_agent.collectors.event_schema import StandardEvent, create_event
from architecture.data_agent.mcp_servers.common.utils import setup_logger, create_error_response, create_success_response
from architecture.attacker_agent.mcp_servers.attack_injector.dataset_loader import (
    get_pattern_by_id,
    filter_patterns,
...
def generate_events_from_pattern(
    ...
    severity = pattern.get("severity", "unknown")  # Get severity from pattern
