...
from architecture.data_agent.mcp_servers.common.utils import setup_logger, create_error_response
...
def list_attack_patterns(
    ...
    """
    from architecture.data_agent.mcp_servers.common.utils import create_success_response
